...
const CheckoutPopup = ({ show, handleClose, cartItems, totalPrice }) => {
  ...
  const convertBase64ToDataURL = (base64String, mimeType = 'image/jpeg') => {
    // if (!base64String) return unplugged; // This will give error if unplugged is not defined. Instead, we can return a placeholder image URL.
    if (!base64String) return "https://picsum.photos/80"; // Use this placeholder image if no data is available.
